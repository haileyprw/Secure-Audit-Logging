...
def test_authorization(sub, obj, act, expected_result):
    global test_number
    result = check_authorization(sub, obj, act)[0]

    if result == expected_result:
        r_string = "PASSED"
    else:
        r_string = f"FAILED - LOGGED@{log_line:03}"
        log_line+=1
...
def test_grant(sub, obj, act, expected_result):
    global test_number
    result = grant_permission(sub, obj, act)
...
#test grant
grant_permission("JOHN", "something.doc", "WRITE")
test_authorization("JOHN", "something.doc", "WRITE", True)
#test 13

#test revoke
revoke_permission("JOHN", "something.doc", "WRITE")
test_authorization("JOHN", "something.doc", "WRITE", False)
#test 14

#test time-based permission
grant_permission("JOHN", "something.doc", "WRITE", 3) #3-second permission
test_authorization("JOHN", "something.doc", "WRITE", True)
...
grant_permission("JOHN", "something.doc", "WRITE", 10) #10-second permission
test_authorization("JOHN", "something.doc", "WRITE", True)
revoke_permission("JOHN", "something.doc", "WRITE")
test_authorization("JOHN", "something.doc", "WRITE", False)
#test 17-18
...
revoke_permission("JOE", "something.doc", "OWN")
